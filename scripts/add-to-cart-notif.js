$(function() {
    ...
    function addNotif(cartBtnData) {
        addToCartNotif.append('<article id="cart-notif-'+latestNotif+'" class="cart-notif"><button class="close-notif-btn"><i class="fa fa-close"></i></button><label for=""><span id="add-to-cart-placeholder">'+cartBtnData+'</span> is added to your Shopping Cart.</label><a href="shopping-cart">Check your Shopping Cart.</a></article>');
